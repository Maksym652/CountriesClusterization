...
{
    class FarthestNeighborMethod : IClusteringMethod
    {
        public string Name => "Метод найдальшого сусіда";
        ...
        public FarthestNeighborMethod(IDistanceMeasure<Country> distanceMeasure)
        {
